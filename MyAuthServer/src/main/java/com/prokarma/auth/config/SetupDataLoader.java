...
import com.prokarma.auth.persistence.dao.PrivilegeRepository;
import com.prokarma.auth.persistence.dao.RoleRepository;
import com.prokarma.auth.persistence.dao.UserRepository;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        // == create initial user
       createUserIfNotFound("admin", "Stephen", "Weinhart", "password", new ArrayList<Role>(Arrays.asList(adminRole)));
